...
class Booth:
    ...
    def register(self, args):
        ...
        self.mqtt_client.publish(BOOTH_TOPIC, {"msg": "register", "id": args[0]})
...
t4 = {"trigger": "sys_err", "source": "operative", "target": "out_of_order"}
...
class MQTT_Client_1:
    ...
    def on_message(self, client, userdata, msg):
        ...
        if (
            ...
            self.stm_driver.send("send", "booth", args=[payload["id"], payload["msg"]])
...
booth_machine = Machine(
    transitions=[t0, t1, t2, t3, t4], states=[s, s1], obj=booth, name="booth"
)
